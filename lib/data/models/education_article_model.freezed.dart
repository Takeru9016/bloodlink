...
mixin _$EducationArticleModel {
 ...
 String get title; String get body; EducationArticleCategory get category; int get displayOrder; String get updatedBy;@TimestampConverter() Timestamp get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,body,category,displayOrder,updatedBy,updatedAt);

@override
String toString() {
  return 'EducationArticleModel(title: $title, body: $body, category: $category, displayOrder: $displayOrder, updatedBy: $updatedBy, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String title, String body, EducationArticleCategory category, int displayOrder, String updatedBy,@TimestampConverter() Timestamp updatedAt
});
...
/// Create a copy of EducationArticleModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? body = null,Object? category = null,Object? displayOrder = null,Object? updatedBy = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String body,  EducationArticleCategory category,  int displayOrder,  String updatedBy, @TimestampConverter()  Timestamp updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EducationArticleModel() when $default != null:
return $default(_that.title,_that.body,_that.category,_that.displayOrder,_that.updatedBy,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String body,  EducationArticleCategory category,  int displayOrder,  String updatedBy, @TimestampConverter()  Timestamp updatedAt)  $default,) {final _that = this;
switch (_that) {
case _EducationArticleModel():
return $default(_that.title,_that.body,_that.category,_that.displayOrder,_that.updatedBy,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String body,  EducationArticleCategory category,  int displayOrder,  String updatedBy, @TimestampConverter()  Timestamp updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _EducationArticleModel() when $default != null:
return $default(_that.title,_that.body,_that.category,_that.displayOrder,_that.updatedBy,_that.updatedAt);case _:
  return null;
...
class _EducationArticleModel implements EducationArticleModel {
  const _EducationArticleModel({required this.title, required this.body, required this.category, required this.displayOrder, required this.updatedBy, @TimestampConverter() required this.updatedAt});
...
/// Create a copy of EducationArticleModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? body = null,Object? category = null,Object? displayOrder = null,Object? updatedBy = null,Object? updatedAt = null,}) {
